...
class DeviceController(customtkinter.CTk):
    def __init__(self):
        ...
        left_panel = customtkinter.CTkFrame(
            self, bg_color="grey30", width=200, height=400
        )
        left_panel.pack(side="left", fill="y", padx=10, pady=10)

        # Create the right panel
        right_panel = customtkinter.CTkFrame(
            self, bg_color="grey30", width=500, height=600
        )
        right_panel.pack(side="right", fill="both", padx=10, pady=10)

        # images
        off_lamp = customtkinter.CTkImage(
            light_image=Image.open("Images\Off-Lamp.png"), size=(120, 120)
        )
        on_lamp = customtkinter.CTkImage(
            light_image=Image.open("Images\On-Lamp.png"), size=(120, 120)
        )
        ac = customtkinter.CTkImage(
            light_image=Image.open("Images\AC.png"), size=(120, 120)
        )
        rgb = customtkinter.CTkImage(
            light_image=Image.open("Images\RGB.png"), size=(120, 120)
        )
        fridgecat = customtkinter.CTkImage(
            light_image=Image.open("Images\Fridgecat.png"), size=(120, 120)
        )
        hp = customtkinter.CTkImage(
            light_image=Image.open("Images\Heat_Pump.png"), size=(120, 120)
        )
        mpajouria = customtkinter.CTkImage(
            light_image=Image.open("Images\Shutters.png"), size=(120, 120)
        )
        opened_garagedoor = customtkinter.CTkImage(
            light_image=Image.open("Images\Opened_Garage.png"), size=(120, 120)
        )
        closed_garagedoor = customtkinter.CTkImage(
            light_image=Image.open("Images\Closed_Garage.png"), size=(120, 120)
        )
        water_sprinkles = customtkinter.CTkImage(
            light_image=Image.open("Images\Watering.png"), size=(120, 120)
        )
        thermostat = customtkinter.CTkImage(
            light_image=Image.open("Images\Thermostat.png"), size=(120, 120)
        )
        water_heater = customtkinter.CTkImage(
            light_image=Image.open("Images\HotTabStream.png"), size=(120, 120)
        )
        cameraPNG = customtkinter.CTkImage(
            light_image=Image.open("Images\Camera.png"), size=(120, 120)
        )
        forward_arrow = customtkinter.CTkImage(
            light_image=Image.open("Images\Forward.png"), size=(60, 60)
        )
        previous_arrow = customtkinter.CTkImage(
            light_image=Image.open("Images\Previous.png"), size=(60, 60)
        )
        entrance = customtkinter.CTkImage(
            light_image=Image.open("Images\Entrance.jpg"), size=(780, 465)
        )
        garageCamera = customtkinter.CTkImage(
            light_image=Image.open("Images\GarageCamera.jpg"), size=(780, 465)
        )
        lr1 = customtkinter.CTkImage(
            light_image=Image.open("Images\LR1.jpg"), size=(780, 465)
        )
        lr2 = customtkinter.CTkImage(
            light_image=Image.open("Images\LR2.jpg"), size=(780, 465)
        )
        kitchenCamera = customtkinter.CTkImage(
            light_image=Image.open("Images\Kitchen.jpg"), size=(780, 465)
        )
        g1 = customtkinter.CTkImage(
            light_image=Image.open("Images\Garden1.jpg"), size=(780, 465)
        )
        g2 = customtkinter.CTkImage(
            light_image=Image.open("Images\Garden2.jpg"), size=(780, 465)
        )
        rabbit = customtkinter.CTkImage(
            light_image=Image.open("Images\Rabbit.png"), size=(80, 80)
        )
        turtle = customtkinter.CTkImage(
            light_image=Image.open("Images\Turtle.png"), size=(80, 80)
        )
        ...
        def on_lamp_handler_t():
            main_lamp.configure(
                image=on_lamp, fg_color="turquoise1", command=off_lamp_handler_t
            )

        def off_lamp_handler_t():
            main_lamp.configure(
                image=off_lamp, fg_color="turquoise4", command=on_lamp_handler_t
            )

        def on_lamp_handler_r():
            main_lamp.configure(
                image=on_lamp, fg_color="IndianRed1", command=off_lamp_handler_r
            )

        def off_lamp_handler_r():
            main_lamp.configure(
                image=off_lamp, fg_color="IndianRed4", command=on_lamp_handler_r
            )
        ...
        def on_side_lamps_handler_t():
            side_lamps.configure(
                image=on_lamp, fg_color="turquoise1", command=off_side_lamps_handler_t
            )

        def off_side_lamps_handler_t():
            side_lamps.configure(
                image=off_lamp, fg_color="turquoise4", command=on_side_lamps_handler_t
            )

        def on_side_lamps_handler_r():
            side_lamps.configure(
                image=on_lamp, fg_color="IndianRed1", command=off_side_lamps_handler_r
            )

        def off_side_lamps_handler_r():
            side_lamps.configure(
                image=off_lamp, fg_color="IndianRed4", command=on_side_lamps_handler_r
            )
        ...
        def open_garagedoor():
            side_lamps.configure(
                image=opened_garagedoor, fg_color="turquoise1", command=close_garagedoor
            )

        def close_garagedoor():
            side_lamps.configure(
                image=closed_garagedoor, fg_color="turquoise4", command=open_garagedoor
            )
        ...
        def led_handler():
            ...
            # Create watch panel
            rgb_panel = customtkinter.CTkFrame(
                popup, bg_color="grey30", width=780, height=400
            )
            rgb_panel.pack(side="top", fill="y", padx=10, pady=10)

            # Create swap panel
            settings_panel = customtkinter.CTkFrame(
                popup, bg_color="grey30", width=780, height=180
            )
            settings_panel.pack(side="bottom", fill="both", padx=10, pady=10)

            red = customtkinter.CTkButton(
                rgb_panel,
                text="",
                fg_color="red",
                bg_color="grey30",
            ...
            red.place(x=5, y=5)
            yellow = customtkinter.CTkButton(
                rgb_panel,
                text="",
                fg_color="yellow",
                bg_color="grey30",
            ...
            dark_violet = customtkinter.CTkButton(
                rgb_panel,
                text="",
                fg_color="dark violet",
                bg_color="grey30",
                cursor="hand2",
                width=170,
                height=170,
            ...
            deep_pink = customtkinter.CTkButton(
                rgb_panel,
                text="",
                fg_color="deep pink",
                bg_color="grey30",
            ...
            mode = customtkinter.CTkComboBox(
                settings_panel,
                values=["Rainbow", "Breath", "Flash", "Steady", "Randomize"],
            )
            mode.place(x=50, y=20)
            speed_slider = customtkinter.CTkSlider(settings_panel, bg_color="grey40")
            speed_slider.place(x=400, y=50)
            slow = customtkinter.CTkLabel(
                settings_panel, text="", image=turtle, width=100, height=100
            )
            slow.place(x=280, y=10)
            fast = customtkinter.CTkLabel(
                settings_panel, text="", image=rabbit, width=100, height=100
            )
        ...
        def open_camera_controler():
            ...
            # Create watch panel
            watch_panel = customtkinter.CTkFrame(
                popup, bg_color="grey30", width=780, height=465
            )
            watch_panel.pack(side="top", fill="y", padx=10, pady=10)

            # Create swap panel
            swap_panel = customtkinter.CTkFrame(
                popup, bg_color="grey30", width=780, height=115
            )
            ...
            forward = customtkinter.CTkButton(
                swap_panel,
                image=forward_arrow,
                text="",
                fg_color="turquoise4",
            ...
            previous = customtkinter.CTkButton(
                swap_panel,
                image=previous_arrow,
                text="",
                fg_color="turquoise4",
                cursor="hand2",
                height=80,
                width=80,
                command=previous_camera,
            )
            previous.place(x=24, y=5)
            cameraLabel = customtkinter.CTkLabel(
                swap_panel,
                text=cameraID[current_camera],
                font=("arial", 27, "bold"),
                text_color="black",
                fg_color="turquoise4",
                height=80,
        ...
        main_lamp = customtkinter.CTkButton(
            right_panel, text="", cursor="hand2", height=200, width=180
        )
        ...
        side_lamps = customtkinter.CTkButton(
            right_panel, text="", cursor="hand2", height=200, width=180
        )
        ...
        aircondition = customtkinter.CTkButton(
            right_panel, text="", cursor="hand2", height=200, width=180
        )
        ...
        ithvan_security = customtkinter.CTkLabel(
            right_panel,
            text="Ithvan Security",
            font=("System", 24, "bold"),
            fg_color="CadetBlue4",
            height=60,
            width=145,
        )
        shutters = customtkinter.CTkButton(
            right_panel,
            text="",
            cursor="hand2",
            height=200,
            width=180,
            command=closing_shutters,
        )
        ...
        def open_bedroom():
            ...
            aircondition_slider.configure(
                from_=15, to=28, bg_color="CadetBlue4", command=temperature
            )
            temperatureL.configure(text="22.5", fg_color="CadetBlue4")

            shutters.place(x=255, y=300)
            shutters.configure(
                image=mpajouria, fg_color="turquoise4", command=closing_shutters
            )
        ...
        def open_LR():
            ...
            aircondition_label.place(x=55, y=515)
            aircondition_slider.place(x=5, y=555)
            aircondition.configure(
                image=rgb, fg_color="IndianRed4", command=led_handler
            )
            aircondition_label.configure(
                text="Adjust Brightness", fg_color="RosyBrown4"
            )
            ...
            shutters_slider.configure(
                from_=15, to=28, bg_color="RosyBrown4", command=temperature
            )
        ...
        def open_kitchen():
            ...
            side_lamps.configure(
                image=fridgecat, fg_color="turquoise1", cursor="", command=None
            )
            side_lamps_label.configure(text="Temnperature", fg_color="CadetBlue4")
            side_lamps_slider.configure(
                from_=2, to=8, bg_color="CadetBlue4", command=temperature
            )
        ...
        def open_bathroom():
            ...
            side_lamps_slider.configure(
                from_=1, to=5, bg_color="RosyBrown4", command=heatpump_switch
            )
        ...
        def open_garden():
            ...
            scale.place(x=438, y=265)
            side_lamps.configure(
                image=water_sprinkles, fg_color="IndianRed4", command=on_water_sprinkles
            )
        ...
        def open_others():
            ...
            main_lamp.configure(
                image=thermostat, fg_color="turquoise4", command=on_thermo
            )
            main_lamp_label.configure(text="Temperature", fg_color="CadetBlue4")
            main_lamp_slider.configure(
                from_=18, to=30, bg_color="CadetBlue4", command=temperature
            )
            ...
            scale.place(x=438, y=265)
            side_lamps.configure(
                image=water_heater, fg_color="turquoise4", command=on_water_heater
            )
            side_lamps_label.configure(
                text="Heating Temperature", fg_color="CadetBlue4"
            )
            side_lamps_slider.configure(
                from_=45, to=85, bg_color="CadetBlue4", command=heatpump_switch
            )
            ...
            aircondition.configure(
                image=cameraPNG, fg_color="turquoise4", command=open_camera_controler
            )

        # buttons for different rooms
        bedroom = customtkinter.CTkButton(
            left_panel,
            text="Bedroom",
            font=("arial", 27, "bold"),
            fg_color="turquoise4",
            ...
            height=60,
            width=180,
            command=open_bedroom,
        )
        bedroom.place(x=10, y=20)
        living_room = customtkinter.CTkButton(
            left_panel,
            text="Living Room",
            font=("arial", 27, "bold"),
            fg_color="IndianRed4",
        ...
        kitchen = customtkinter.CTkButton(
            left_panel,
            text="Kitchen",
            font=("arial", 27, "bold"),
            fg_color="turquoise4",
            ...
            height=60,
            width=180,
            command=open_kitchen,
        )
        kitchen.place(x=10, y=180)
        bathroom = customtkinter.CTkButton(
            left_panel,
            text="Bathroom",
            font=("arial", 27, "bold"),
            fg_color="IndianRed4",
            ...
            height=60,
            width=180,
            command=open_bathroom,
        )
        bathroom.place(x=10, y=260)
        garage = customtkinter.CTkButton(
            left_panel,
            text="Garage",
            font=("arial", 27, "bold"),
            fg_color="turquoise4",
        ...
        garden = customtkinter.CTkButton(
            left_panel,
            text="Garden",
            font=("arial", 27, "bold"),
            fg_color="IndianRed4",
        ...
        other_devices = customtkinter.CTkButton(
            left_panel,
            text="Other",
            font=("arial", 27, "bold"),
            fg_color="turquoise4",
