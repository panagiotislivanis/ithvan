    ...
    def __init__(self):
        ...
        def card_manager():
            def show_cards():
                ...
                cards_list = Listbox(popup, font=('Arial',18), background='grey20', width=34, height=12)
                ...
                def back_to_cards():
                    ...
                    def add_card_to_back():
                        ...
                        crs.execute('INSERT INTO myShop_cards (number, owner, CVV, exp_date) VALUES (?, ?, ?, ?);', (entry_number, entry_owner, entry_cvv, entry_expdate))
                        conn.commit()
                        crs.close()
                    
                    card_numberLB = customtkinter.CTkLabel(popup, text="Card Number", font=('Comic Sans MS', 16, 'bold'), text_color="light green")
                    card_number = customtkinter.CTkTextbox(popup, font=('Arial', 16), fg_color="grey30", height=30, width=430)
                    ownerLB = customtkinter.CTkLabel(popup, text="Owner", font=('Comic Sans MS', 16, 'bold'), text_color="light green")
                    owner = customtkinter.CTkTextbox(popup, font=('Arial', 16), fg_color="grey30", height=30, width=430)
                    cvvLB = customtkinter.CTkLabel(popup, text="CVV", font=('Comic Sans MS', 16, 'bold'), text_color="light green")
                    cvv = customtkinter.CTkTextbox(popup, font=('Arial', 16), fg_color="grey30", height=30, width=120)
                    expdateLB = customtkinter.CTkLabel(popup, text="Exparation Date", font=('Comic Sans MS', 16, 'bold'), text_color="light green")
                    expdate = customtkinter.CTkTextbox(popup, font=('Arial', 16), fg_color="grey30", height=30, width=180)
                    save_card = customtkinter.CTkButton(popup, text="Save Card", font=('Arial', 18, "bold"), text_color="grey30", fg_color="light green", cursor="hand2", height=30, width=40, command=add_card_to_back)
            ...
            card_numberLB = customtkinter.CTkLabel(popup, text="Card Number", font=('Comic Sans MS', 16, 'bold'), text_color="light green")
            card_number = customtkinter.CTkEntry(popup, font=('Arial', 16), fg_color="grey30", height=30, width=430)
            ownerLB = customtkinter.CTkLabel(popup, text="Owner", font=('Comic Sans MS', 16, 'bold'), text_color="light green")
            owner = customtkinter.CTkEntry(popup, font=('Arial', 16), fg_color="grey30", height=30, width=430)
            cvvLB = customtkinter.CTkLabel(popup, text="CVV", font=('Comic Sans MS', 16, 'bold'), text_color="light green")
            cvv = customtkinter.CTkEntry(popup, font=('Arial', 16), fg_color="grey30", height=30, width=120)
            expdateLB = customtkinter.CTkLabel(popup, text="Exparation Date", font=('Comic Sans MS', 16, 'bold'), text_color="light green")
            expdate = customtkinter.CTkEntry(popup, font=('Arial', 16), fg_color="grey30", height=30, width=180)
            save_card = customtkinter.CTkButton(popup, text="Save Card", font=('Arial', 18, "bold"), text_color="grey30", fg_color="light green", cursor="hand2", height=30, width=40, command=add_card)
            my_cards = customtkinter.CTkButton(popup, text="My Cards", font=('Arial', 40, "bold"), text_color="grey30", fg_color="light green", cursor="hand2", height=80, width=300, command=show_cards)
        ...
        name = customtkinter.CTkEntry(main_panel, font=('Arial', 16), fg_color="grey30", height=30, width=400)
        emailLB = customtkinter.CTkLabel(main_panel, text="Email", font=('Comic Sans MS', 16, 'bold'), text_color="light green")
        email = customtkinter.CTkEntry(main_panel, font=('Arial', 16), fg_color="grey30", height=30, width=400)
        countryLB = customtkinter.CTkLabel(main_panel, text="Country", font=('Comic Sans MS', 16, 'bold'), text_color="light green")
        country = customtkinter.CTkEntry(main_panel, font=('Arial', 16), fg_color="grey30", height=30, width=400)
        adressLb = customtkinter.CTkLabel(main_panel, text="Adress", font=('Comic Sans MS', 16, 'bold'), text_color="light green")
        adress = customtkinter.CTkEntry(main_panel, font=('Arial', 16), fg_color="grey30", height=30, width=400)
        postalcodeLb = customtkinter.CTkLabel(main_panel, text="Postal Code", font=('Comic Sans MS', 16, 'bold'), text_color="light green")
        postalcode = customtkinter.CTkEntry(main_panel, font=('Arial', 16), fg_color="grey30", height=30, width=400)
        ...
        def open_prof():
            ...
            def save_changes():
                ...
                crs.execute('UPDATE myShop_prof SET name=(?), email=(?), country=(?), adress=(?), postalcode=(?) WHERE id=1;', (entry_name, entry_email, entry_country, entry_adress, entry_postalcode))
                conn.commit()
                crs.close()
            ...
            submit_button.configure(text="Save changes", font=('Comic Sans MS', 16, 'bold'), text_color="grey30", height=30, width=90, command=save_changes)
            submit_button.place(x=350, y=580)
            cancel_button.configure (text="Discard changes", font=('Comic Sans MS', 16, 'bold'), text_color="grey30", height=30, width=90, command=discard_changes)
